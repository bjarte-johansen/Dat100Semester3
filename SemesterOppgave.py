"""
    Note:
        ...
        advanced weighting function, that mimics the original.
        ...
        further (we should have used tkinter or similar !!)

        - We have changed the application to use start/end date instead of relying on
        fixed constants due to problems with different days in months, leap years etc.
    ...
    Problems:
        ...
        large datasets. Originally the application was designed for performance but we
        ...
        when it comes to plotting data with correct labels and ticks etc.
    ...
    Coding:
        ...
        and measurement_value fields to facility for code reuse (read below)
        ...
        - these two combined allows us to easily extend the application with more data types and locations
        and we can easily iterate over locations and data types in the plotting functions
